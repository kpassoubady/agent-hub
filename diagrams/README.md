...
| [02-distribution.md](02-distribution.md) | How a single hub feeds Claude Code (global install), Devin (per-workspace sync), Gemini/Antigravity (plugin), and GitHub Copilot |
